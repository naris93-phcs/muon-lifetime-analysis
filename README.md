...
<p align="center">
  <img src="images/experimental_setup_diagram.png"
       alt="Experimental setup for the cosmic muon lifetime measurement"
       width="92%">
</p>

<p align="center">
  <b>Figure 1.</b> Schematic of the two-scintillator detector, PMT readout, coincidence trigger and oscilloscope acquisition chain.
</p>
...
│
├── diagnostics/
│   └── Detector validation scripts
│
├── images/
│   ├── muon_lifetime_analysis_banner.png
│   ├── experimental_setup_diagram.png
│   └── results/
│       ├── exponential_tail_fit.png
│       ├── fit_range_stability.png
│       ├── accepted_event_example.png
│       └── rejected_event_example.png
│
├── results/
│   └── Generated analysis outputs (gitignored)
│
├── src/
│   ├── analysis.py
│   ├── config.py
...
<p align="center">
<img src="images/figures/exponential_tail_fit.png" width="900">
</p>

<p align="center">
<b>Figure 2.</b> Exponential model fitted to the late-time region of the accepted decay-time distribution. The fitted tail is extrapolated towards earlier times, revealing an excess of short-delay events relative to the exponential expectation.
</p>
...
<p align="center">
<img src="images/figures/fit_range_stability.png" width="850">
</p>

<p align="center">
<b>Figure 3.</b> Fit-range stability study showing the estimated lifetime as a function of the lower fit boundary.
</p>
...
<p align="center">
  <img src="images/figures/accepted_event_example.png"
       alt="Accepted stopped-muon decay candidate"
       width="95%">
</p>

<p align="center">
  <b>Figure 4.</b> Example of an accepted delayed-pulse candidate. The upper panel shows the complete post-trigger waveform, while the lower panel magnifies the local coincidence-veto window around the selected decay pulse. The candidate is retained because the delayed pulse is significant in Channel 2 and no sufficiently strong simultaneous veto pulse is observed in Channel 1.
</p>

## Rejected Event Example

<p align="center">
  <img src="images/figures/rejected_event_example.png"
       alt="Rejected delayed-pulse candidate"
       width="95%">
</p>

<p align="center">
  <b>Figure 5.</b> Example of a rejected delayed-pulse candidate. A strong simultaneous pulse is present in Channel 1 at the candidate time, activating the coincidence-veto criterion and preventing the event from entering the lifetime sample.
</p>
